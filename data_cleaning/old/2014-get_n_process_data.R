...
# take storm events data for 2014
# https://www1.ncdc.noaa.gov/pub/data/swdi/stormevents/csvfiles/StormEvents_details-ftp_v1.0_d2015_c20170216.csv.gz
storm_events <- as.data.frame(read.csv("StormEvents_details-ftp_v1.0_d2014_c20160617.csv.gz", stringsAsFactors = FALSE))
...
#save.image("data/2014_snapshot_2017-8-1-1630.RData")
